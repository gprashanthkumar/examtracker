...
,CASE WHEN ret.end_exam is null then ret.end_exam else ret.end_exam END end_exam
  ...
  def self.get_tech_exams(employeeid)
    ...
    s = self.Radiologist.where("rad_reports.rad1_id = ? or rad_reports.rad2_id = ? or rad_reports.rad3_id = ? or rad_reports.rad4_id = ? ", employeeid, employeeid, employeeid, employeeid) ;
