    ...
    function createOrUpdateRadExamGrid() {
        ...
        $("#tblRadExam").jqGrid({
            ...
            colModel: [
                ...
                , {name: 'appt_time', index: 'appt_time', align: 'center', width: 150, fixed: true, formatter: format_date_time, sorttype: 'date'}
                , {name: 'begin_exam', index: 'begin_exam', align: 'center', width: 150, fixed: true, formatter: TimeFromDateTime, sorttype: 'date'}
                , {name: 'end_exam', index: 'end_exam', align: 'center', width: 150, fixed: true, formatter: TimeFromDateTime, sorttype: 'date'}
                , {name: 'sign_in', index: 'sign_in', align: 'center', width: 150, fixed: true, formatter: TimeFromDateTime}
                , {name: 'check_in', index: 'check_in', align: 'center', width: 140, fixed: true, formatter: TimeFromDateTime, sorttype: 'date'}
